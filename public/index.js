...
myMap.on("click", async (e) => {
    ...
    try {
        ...
        const youtubeUrl = `https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=50&type=video&location=${lat},${lng}&locationRadius=1m&key=AIzaSyD1c4bzFTJ_gjUjUydPL3gGtgJ91CL5NtA`;
